							...
							children: (
								<div className='flex flex-col'>
									...
									<CodeSnippet
										theme={theme}
										established
										code={`namadac init-validator --commission-rate 0.07 --max-commission-rate-change 1 --signing-keys $WALLET --alias $ALIAS --email <EMAIL_ADDRESS> --website <WEBSITE> --discord-handle <DISCORD> --account-keys $WALLET --memo $MEMO`}
									/>
									<span>
