...
const Upgrade = ({ name, type }) => {
	...
	return (
		<AnimatedSection>
			...
			>
				<CodeBlock
					desc='Upgrade to v0.31.10'
					code={`cd $HOME
rm -rf namada
git clone https://github.com/anoma/namada
cd namada
wget https://github.com/anoma/namada/releases/download/v0.31.10/namada-v0.31.10-Linux-x86_64.tar.gz
tar -xvf namada-v0.31.10-Linux-x86_64.tar.gz
rm namada-v0.31.10-Linux-x86_64.tar.gz
cd namada-v0.31.10-Linux-x86_64
